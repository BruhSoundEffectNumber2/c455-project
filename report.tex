...
As described before, the formal equation for the map is:$$H(x) = \frac{\lambda x}{\left( x + 1 \right)^\beta}, \, x \geq 0, \, \lambda \geq 0, \, \beta \geq 0$$ We found the fixed points of the map analytically, by solving for $H(x) = x$. There is always a fixed point at $0$, as well as a second fixed point when $\lambda \geq 1$. The exact position and stability of the fixed points will be covered in detail later.
